<template>
  ...
  <v-dialog v-model="isDialogOpen" max-width="600">
    <v-card class="mx-auto">
      ...
      <v-form v-model="isFormValid" @submit.prevent="openGmail">
        <v-card-text>
          <v-row>
            ...
            <v-col cols="12" class="input-group">
              <v-text-field label="Name (Optional)" v-model="form.name"></v-text-field>
            </v-col>
            <v-col cols="12" class="input-group">
            ...
            <v-col cols="4" offset="5">
              <v-btn color="#0A2E49" @click="openGmail" :disabled="!isFormValid">Send</v-btn>
            </v-col>
          </v-row>
        </v-card-text>
      </v-form>
...
function openGmail() {
  ...
  const recipient = 'massa@gmail.com';
